      ...
      {isLeft ? (
        <>
          ...
          <div className="hidden md:flex md:w-[calc(50%-40px)] md:justify-end md:pr-8 group/card">
            <div className="engineering-card p-6 w-full group-hover/card:border-primary/50 group-hover/card:shadow-lg group-hover/card:shadow-primary/15 transition-all duration-300">
              ...
              <h4 className="text-base text-primary font-bold mb-4">
                {exp.company}
              </h4>
          ...
          {/* Center Icon + Line */}
          <div className="hidden md:flex md:w-20 md:justify-center md:relative md:z-10 md:flex-col md:items-center">
            ...
            <div
              className={`absolute top-1/2 w-8 h-0.5 ${language === "ar" ? "-right-8 bg-gradient-to-r" : "-left-8 bg-gradient-to-l"} from-primary/60 to-primary/0`}
            />
          </div>
        ...
        <>
          ...
          <div className="hidden md:flex md:w-20 md:justify-center md:relative md:z-10 md:flex-col md:items-center">
            ...
            {/* Connection line to card */}
            <div
              className={`absolute top-1/2 w-8 h-0.5 ${language === "ar" ? "-left-8 bg-gradient-to-l" : "-right-8 bg-gradient-to-r"} from-primary/60 to-primary/0`}
            />
          </div>
