        ...
        dashboard: {
            ...
            dialogs: {
                ...
                personalInfo: {
                    ...
                    telegram: "Telegram",
                    whatsapp: "WhatsApp",
                    floatingSkills: "Core Skills",
                    floatingSkillsLabel: "Skills shown in the portfolio Core Skills section (comma-separated)",
                    floatingSkillsHelp: "Add, remove, or reorder skills here. Unknown names appear with a generic code icon.",
                    cvResume: "CV & Resume",
        ...
        dashboard: {
            ...
            dialogs: {
                ...
                personalInfo: {
                    ...
                    telegram: "Telegram",
                    whatsapp: "WhatsApp",
                    floatingSkills: "المهارات الأساسية",
                    floatingSkillsLabel: "المهارات الظاهرة في قسم Core Skills في الموقع (مفصولة بفواصل)",
                    floatingSkillsHelp: "يمكنك الإضافة والحذف وإعادة الترتيب من هنا. الأسماء غير المعروفة تظهر بأيقونة عامة.",
