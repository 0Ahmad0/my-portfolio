        ...
        dashboard: {
            ...
            dialogs: {
                ...
                testimonial: {
                    ...
                    country: "Country",
                    placeholderCountry: "Search or type a country",
                    textEn: "Testimonial Text (English)",
                    textAr: "Testimonial Text (Arabic)",
                    highlightEn: "Highlights (English)",
                    highlightAr: "Highlights (Arabic)",
                    ...
                    placeholderCompanyEn: "Company name",
                    placeholderCompanyAr: "اسم الشركة",
                    placeholderTextEn: "Share what you loved about working together...",
                    placeholderTextAr: "شارك ما أعجبك...",
                    placeholderHighlightEn: "Communication · Quality",
                    placeholderHighlightAr: "التعاون · جودة العمل",
                ...
                personalInfo: {
                    ...
                    telegram: "Telegram",
                    whatsapp: "WhatsApp",
                    floatingSkills: "Featured Skills",
                    floatingSkillsLabel: "Six skills shown around the avatar (comma-separated)",
                    floatingSkillsHelp: "These are only the floating avatar icons. Keep the strongest six here.",
                    coreSkills: "Core Skills",
                    coreSkillsLabel: "Skills shown in the portfolio Core Skills section (comma-separated)",
                    coreSkillsHelp: "Add, remove, or reorder skills here. Unknown names appear with a generic code icon.",
                    cvResume: "CV & Resume",
                    cvUrl: "CV Download URL",
                    placeholderAvatar: "https://...",
                    placeholderFloating: "React, Flutter, TypeScript, Node.js, Figma, Next.js",
                    placeholderCoreSkills: "React, Flutter, Next.js, TypeScript, Node.js, Python, C++, Dart",
        ...
        dashboard: {
            ...
            dialogs: {
                ...
                testimonial: {
                    ...
                    companyEn: "الشركة (إنجليزي)",
                    companyAr: "الشركة (عربي)",
                    country: "الدولة",
                    placeholderCountry: "ابحث عن الدولة أو اكتبها",
                    textEn: "النص (إنجليزي)",
                    textAr: "النص (عربي)",
                    highlightEn: "أبرز النقاط (إنجليزي)",
                    highlightAr: "أبرز النقاط (عربي)",
                ...
                personalInfo: {
                    ...
                    telegram: "Telegram",
                    whatsapp: "WhatsApp",
                    floatingSkills: "المهارات البارزة",
                    floatingSkillsLabel: "ست مهارات تظهر حول الصورة (مفصولة بفواصل)",
                    floatingSkillsHelp: "هذه فقط أيقونات الصورة. ضع هنا أقوى ست مهارات.",
                    coreSkills: "المهارات الأساسية",
                    coreSkillsLabel: "المهارات الظاهرة في قسم Core Skills في الموقع (مفصولة بفواصل)",
                    coreSkillsHelp: "يمكنك الإضافة والحذف وإعادة الترتيب من هنا. الأسماء غير المعروفة تظهر بأيقونة عامة.",
